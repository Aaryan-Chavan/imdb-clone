...
const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-2xl w-full bg-gray-900 bg-opacity-60 p-10 rounded-lg shadow-xl space-y-2">        <h2 className="text-4xl font-semibold text-white">Welcome Back!</h2>
